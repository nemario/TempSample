...
namespace boardchitless.resourceAccess.APIAccessor_twitter
{
    ...
    public class TwitterApiAccessor
    {
        ...
        public TwitterApiAccessor(string consumerKey, string consumerKeySecret, string accessToken, string accessTokenSecret)
        {
